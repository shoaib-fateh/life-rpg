    ...
    >
      ...
      <Particles
        ...
        options={{
          ...
          particles: {
            number: { value: 80 },
            color: { value: ["#f0abfc", "#c084fc", "#a855f7"] },
            move: {
              enable: true,
              speed: 0.5,
              direction: "none",
      ...
      {/* Holographic Title */}
      <motion.h2 
        className="text-3xl font-bold text-transparent bg-clip-text bg-[linear-gradient(90deg,#ec4899,#8b5cf6,#3b82f6)] mb-6 tracking-wider uppercase text-center"
        animate={{
      ...
      <div className="absolute top-0 left-0 w-48 h-48 bg-purple-600/10 rounded-full filter blur-[100px] -z-10"></div>
      <div className="absolute bottom-0 right-0 w-56 h-56 bg-pink-600/10 rounded-full filter blur-[100px] -z-10"></div>
    </motion.div>
  );
};
